...
namespace PROProtocol
{
    public static class XorEncryption
    {
        ...
        {
            sendState = new State(Master_Key);
            recvState = new State(Recv_Master_Key);
        }
