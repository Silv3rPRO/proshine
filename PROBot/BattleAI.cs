...
namespace PROBot
{
    public class BattleAI
    {
        ...
        public bool LegacyAttack(bool useBestAttack = true)
        {
            ...
            if (LegacySendNextPokemon())
            {
                return true;
            }
            if (_client.ActiveBattle.IsWild && LegacyRun())
            {
                return true;
            }
            return false;
        ...
        public bool LegacyUseItem(int itemId, int pokemonUid = 0)
        {
            if (LegacyUsePreconditions())
            {
                return true;
        ...
        public bool LegacyRun()
        {
            ...
            if (!_client.ActiveBattle.IsWild)
            {
                return LegacyAttack();
            }
            _client.RunFromBattle();
        ...
        private bool LegacyUsePreconditions()
        {
            if (RepeatAttack())
            {
                return true;
            ...
            {
                return LegacySendNextPokemon();
            }
            return false;
        }

        public bool LegacySendNextPokemon()
        {
