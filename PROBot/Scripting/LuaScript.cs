...
namespace PROBot.Scripting
{
    public class LuaScript : BaseScript
    {
        ...
        // Sets the option at a particular index, or created it if it doesn't exist
        ...
        // Gets the option at a particular index, or created it if it doesn't exist
        ...
        // Sets the name of the option at a particular index, or created it if it doesn't exist
        ...
        // Sets the tooltip description of the option at a particular index, or created it if it doesn't exist
